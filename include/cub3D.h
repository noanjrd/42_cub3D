...
void		init_draw_start_end(int *draw_start, int *draw_end,
...
void		calcul_distance_x(t_data *data, double *side_dist_x,
				int *step_x);
void		calcul_distance_y(t_data *data, double *side_dist_y,
				int *step_y);
